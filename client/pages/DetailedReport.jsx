...
import { FaCalendarAlt, FaFilter, FaDownload, FaSun, FaMoon } from "react-icons/fa";
import "./print.css";
...
const DetailedReport = () => {
  ...
  const [transactions, setTransactions] = useState([
    ...
    { id: 8, transactionDate: "2025-03-15", description: "Another Monthly Savings", category: "Savings", transactionType: "Credit", amount: 2000, paymentMethod: "Bank Transfer", counterparty: "Self" },
    { id: 9, transactionDate: "2025-03-20", description: "Another Lent to Friend", category: "Lent", transactionType: "Debit", amount: 5000, paymentMethod: "Cash", counterparty: "Friend" },
  ]);
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'} text-gray-900 flex flex-col transition-colors duration-300`}>
      <main className="container mx-auto py-8 px-4 flex-grow">
        <header className="flex justify-between items-center mb-8">
          {/* MODIFIED: Added dark mode gradient colors for the heading */}
          {/* <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-500 dark:from-blue-400 dark:to-teal-400">
...
>
  Detailed Transaction Report
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-8 p-6 rounded-xl shadow-lg bg-white dark:bg-gray-800 transition-colors duration-300">
          <div className="w-full md:w-1/4">
            ...
            <input
              ...
              className="mt-1 w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900"
            />
          </div>
          <div className="w-full md:w-1/4">
            <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
        ...
        <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-colors duration-300">
          ...
          >
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-teal-600 dark:bg-teal-800 sticky top-0 z-10">
                <tr>
                  {[
                    "Date", "Description", "Category", "Type",
                    "Amount", "Payment Method", "Counterparty",
                  ].map((heading) => (
                    <th
                      key={heading}
              ...
              <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200">
                {filteredData.length > 0 ? (
                  filteredData.map((txn) => (
                    <tr key={txn.id} className="hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
